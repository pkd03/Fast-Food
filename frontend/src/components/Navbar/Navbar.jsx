...
const Navbar = ({ setShowLogin }) => {
  ...
  const handleMenuClick = (menu) => {
    ...
    navigate(`/${menu}`); // Navigate to the respective route
  };
  const handleMenuClickHome = (menu) => {
    setActiveMenu(menu); // Set the active menu item
    navigate(`/`); // Navigate to the respective route
  };
  return (
    <div className="navbar">
      ...
      <li
          onClick={() => handleMenuClickHome("home")}
          className={`home ${activeMenu === "home" ? "active" : ""}`}
        >
          Trang chủ
        </li>
        <li
          onClick={() => handleMenuClick("foods")}
          className={`menu ${activeMenu === "foods" ? "active" : ""}`}
        >
          Thực đơn
        </li>
        <li
          onClick={() => handleMenuClick("footer")}
          className={`contact-us ${activeMenu === "footer" ? "active" : ""}`}
        >
          Liên hệ
        </li>
      </ul>
